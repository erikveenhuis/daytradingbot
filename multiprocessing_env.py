...
def train_multiprocessing(CustomEnv, agent, mode, num_worker=4, training_batch_size=500, visualize=False, EPISODES=10000):
    ...
    for idx in range(num_worker):
        ...
        env = CustomEnv(mode=mode, lookback_window_size=agent.lookback_window_size)
...
def test_multiprocessing(CustomEnv, CustomAgent, mode, num_worker = 4, visualize=False, test_episodes=1000, folder="", name="", comment="", initial_balance=1000, Show_reward=False, Show_indicators=False):
    ...
    for idx in range(num_worker):
        ...
        env = CustomEnv(mode=mode, initial_balance=initial_balance, lookback_window_size=agent.lookback_window_size)
